...
$final_data = "request_type=JSON&access_code=" . $access_code . "&command=getRefundDetails&version=1.1&response_type=JSON&enc_request=" . $encrypted_data;
